...
Future<List<AstroBinModel>> getAstroBinPhotos() async {
  ...
  final String parsedStartDate =
      startDate.toUtc().toIso8601String().split("T")[0];
  final String parsedEndDate = endDate.toIso8601String().split("T")[0];
  final String url =
      "https://astrobin.com/api/v1/image/?uploaded__gte=$parsedEndDate%200:00:00&uploaded__lt=$parsedStartDate%200:00:00&api_key=9985b5e659306f24f98faa7c5d78fae212622dc1&api_secret=766c984b731d1d522f8e8fb966ec3be20075c23c&limit=$limit";
  ...
  astroBinPhotos
      .sort((a, b) => getAsDate(b.published).compareTo(getAsDate(a.published)));
